      ...
      <div className='container'>
          <div className='digital-card__cart horizontal-gradient shadow'>
            <div className='digital-card__main'>
              ...
              <div className='digital-card__subtitle'>Our best credit card. Suitable for everyday spending and shopping. Cash withdrawals and transfers without commission and interest.</div>
